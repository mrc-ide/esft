...
* Downloading infections and deaths estimates from the WHO website. However, this will likely require a new cases_weekly function - to calculate the severe and critical cases from the WHO data instead of the ICL data.
...
cases <- subset(cases, cases$week_ends > (as.Date("2022-01-03")-7))
