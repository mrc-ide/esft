...
# Uses the country specific diagnostic capacity estimates to calculate the max number of tests per day. This is then used to help cap tests by total testing capacity in total_tests.
