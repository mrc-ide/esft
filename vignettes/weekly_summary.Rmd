...
bed given enough healthcare capacity. Note: this is only included if the data
source is the imperial SEIR fit data.
...
enough healthcare capacity. Note: this is only included if the data
source is the imperial SEIR fit data.
...
hospital bed at the current time. Note: this is only included if the data
source is the imperial SEIR fit data.
...
current time. Note: this is only included if the data
source is the imperial SEIR fit data.
...
Equivalent to the ICU incidence if Imperial, or the new cases multiplied by the
proportion critical if WHO.

10. *new_severe_cases*

Equivalent to the hospital incidence if Imperial, or the new cases multiplied by
the proportion severe if WHO.
